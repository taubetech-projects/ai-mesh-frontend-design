...
export interface paths {
    "/v1/conversations/{conversationId}": {
         ...
         * @description Retrieve a conversation's details using its unique ID
         */
         ...
         * @description Delete a conversation from the system using its ID
         */
    ...
    "/v1/responses": {
        ...
        get?: never;
        put?: never;
        post: operations["responsesOpenAiCompatibility"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/conversations": {
         ...
         * @description Retrieve a list of all conversations in the system
         */
        get: operations["findAllOrderByCreatedAtDesc"];
        put?: never;
        /**
         * Create a new conversation
         * @description Add a new conversation to the system
         */
    ...
    "/v1/conversations/{conversationId}/messages": {
        ...
        get: operations["page"];
        put?: never;
        post: operations["saveAllMessages"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/conversations/{conversationId}/messages/{messageId}": {
        ...
        get?: never;
        put?: never;
        post: operations["saveAllEditedMessages"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/v1/chat/completions/streaming-and-non-streaming/stream": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/v1/chat/completions": {
        ...
        get?: never;
        put?: never;
        post: operations["chatOpenAiCompatibility"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
...
export interface components {
    schemas: {
        ...
        SaveMessageRequest: {
            ...
            model?: string;
            mode?: string;
            parts?: components["schemas"]["MessagePartRequest"][];
        };
        AttachmentView: {
            /** Format: int64 */
            id?: number;
        ...
        ServerSentEventString: Record<string, never>;
...
export interface operations {
    findById: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ConversationView"];
                };
            };
    ...
    update: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["ConversationRequest"];
                };
            };
            /** @description Conversation not found */
            404: {
    ...
    create_1: {
        ...
        responses: {
            ...
            /** @description Invalid conversation request data */
            400: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    page: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["PageResponseMessageView"];
                };
            };
        };
    };
    ...
    enable2fa: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["Enable2FAResponse"];
                };
            };
        };
    };
    presign: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "*/*": components["schemas"]["PresignResponse"];
                };
            };
        };
    };
