                ...
                <Button
                    ...
                    onClick={() =>
                        dispatch({
                            ...
                            payload: { showPlaygroundSettings: false },
                        })
                    }
                >
                    <X className="h-4 w-4" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1 space-y-2">
                    ...
                    <Textarea
                        ...
                        value={systemPrompt}
                        onChange={(e) =>
                            settingsDispatch({ type: UPDATE_SYSTEM_PROMPT, payload: e.target.value })
                        }
                        className="h-48 resize-none bg-background border border-gray-700"
                    />
                </div>
                ...
                <div className="md:col-span-2 grid grid-cols-2 gap-x-4 gap-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            value={temperature}
                            onChange={(e) =>
                                settingsDispatch({ type: UPDATE_TEMPERATURE, payload: e.target.value })
                            }
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <SelectTrigger id="input-format" className="bg-background border-border">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="space-y-2">
                        ...
                        >
                            <SelectTrigger id="output-format" className="bg-background border-border">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="text">Text</SelectItem>
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value) =>
                                settingsDispatch({ type: UPDATE_REASONING_EFFORT, payload: value })
                            }
                        >
                            <SelectTrigger id="reasoning-effort" className="bg-background border-border">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="space-y-2">
                        ...
                        <Input
                            ...
                            value={maxTokens}
                            onChange={(e) =>
                                settingsDispatch({ type: UPDATE_MAX_TOKENS, payload: e.target.value })
                            }
                            className="bg-background border-border"
                            placeholder="4096"
                        />
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            value={String(isStreaming)}
                            onValueChange={(value) =>
                                settingsDispatch({ type: IS_STREAMING, payload: value === 'true' })
                            }
                        >
                            <SelectTrigger id="is-streaming" className="bg-background border-border">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                    ...
                    <div className="space-y-2">
                        ...
                        <Select
                            ...
                            onValueChange={(value) =>
                                settingsDispatch({ type: UPDATE_PROVIDER_SPECIFIC, payload: value === 'true' })
                            }
                        >
                            <SelectTrigger id="provider-specific" className="bg-background border-border">
                                <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
