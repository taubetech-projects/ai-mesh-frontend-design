...
const GoogleIcon = ({ className }: { className: string }) => (
    ...
    >
        ...
        <path fill="#1976D2" d="M43.611,20.083H42V20H24v8h11.303c-0.792,2.237-2.231,4.166-4.087,5.571l6.19,5.238C43.021,36.251,45,30.633,45,24C45,22.659,44.862,21.35,44.611,20.083z"></path>
    </svg>
);
