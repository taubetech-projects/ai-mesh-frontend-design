...
import { ImageInput } from '@/types/imageModels';
...
const defaultProviders: ModelProvider[] = [
    ...
    },
    {
        ...
        name: "ByteDance",
        models: [
            { id: "seedream-4-0-250828", name: "Seedream-4.0", icon: "icons/ollama-64x64.png" }
        ],
    },
];
...
export const {
    toggleModelSelector, addModel, removeModel, setSelectedModels,
    updatePrompt, addUploadedImage, removeUploadedImage, clearUploadedImages, setIsGenerating
